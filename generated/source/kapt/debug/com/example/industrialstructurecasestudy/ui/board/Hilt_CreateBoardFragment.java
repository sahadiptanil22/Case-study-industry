...
public abstract class Hilt_CreateBoardFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_CreateBoardFragment() {
    super();
  }

  Hilt_CreateBoardFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((CreateBoardFragment_GeneratedInjector) this.generatedComponent()).injectCreateBoardFragment(UnsafeCasts.<CreateBoardFragment>unsafeCast(this));
    }
  }
