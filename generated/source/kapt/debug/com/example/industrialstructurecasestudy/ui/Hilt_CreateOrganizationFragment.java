...
public abstract class Hilt_CreateOrganizationFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_CreateOrganizationFragment() {
    super();
  }

  Hilt_CreateOrganizationFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((CreateOrganizationFragment_GeneratedInjector) this.generatedComponent()).injectCreateOrganizationFragment(UnsafeCasts.<CreateOrganizationFragment>unsafeCast(this));
    }
  }
