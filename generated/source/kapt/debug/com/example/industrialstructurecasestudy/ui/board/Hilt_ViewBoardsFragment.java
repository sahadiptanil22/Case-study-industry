...
public abstract class Hilt_ViewBoardsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ViewBoardsFragment() {
    super();
  }

  Hilt_ViewBoardsFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ViewBoardsFragment_GeneratedInjector) this.generatedComponent()).injectViewBoardsFragment(UnsafeCasts.<ViewBoardsFragment>unsafeCast(this));
    }
  }
